 ...
 */
 ...
 export const update = <T>(id: string, newValues: T) => {
    ...
    // 1- user will send patirail state to update
    // 1- user will send whole state to update
    ...
    if(!Array.isArray(currentIdCachedValues) && typeof currentIdCachedValues === "object"){
      currentIdCachedValues = { ...currentIdCachedValues, ...newValues }
